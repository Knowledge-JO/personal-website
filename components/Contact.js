...
export const Contact = () => {
  ...
  return (
    <div className="mx-auto flex flex-col items-center justify-center gap-20 px-5 pb-16 pt-36 sm:px-8 lg:flex-row lg:py-20">
      <article className="grid max-w-2xl flex-1 gap-10 text-center">
        ...
        <div className="grid gap-10 text-sm">
          <div className="grid gap-2">
            <h2 className="text-lg font-bold tracking-widest">Socials</h2>
            <div className="tracking-wider text-neutral-400 mt-2">
              <Socials positioned={false} />
            </div>
          </div>
          <div className="grid gap-2">
            ...
            <p className="tracking-wider text-neutral-400">
              <a
                href="mailto:megamindtheincredible@gmail.com"
      ...
      <form className="grid w-full max-w-xl flex-1 gap-10 rounded-xl bg-opacity-50 backdrop-blur-lg backdrop-filter md:p-14 md:shadow-2xl">
